        ...
        "items": [
            {
                "title": _("Konkurslar"),
                "icon": "trophy",
                "link": reverse_lazy("admin:Bot_contest_changelist"),
                "permission": lambda request: user_has_group_or_permission(
                    request.user, "view_contest"
                ),
            },
            {
                "title": _("Konkurs shartlari"),
                "icon": "⚡️",
                "link": reverse_lazy("admin:Bot_contestcondition_changelist"),
                "permission": lambda request: user_has_group_or_permission(
                    request.user, "view_contestcondition"
                ),
            },#ConditionCheck
            {
                "title": _("Konkurs qatnashchilari"),
                "icon": "people",
                "link": reverse_lazy("admin:Bot_contestparticipant_changelist"),
                "permission": lambda request: user_has_group_or_permission(
                    request.user, "view_contestparticipant"
                ),
            },
            {
                "title": _("Shartlar bajarilishi"),
                "icon": "⁉️",
                "link": reverse_lazy("admin:Bot_conditioncheck_changelist"),
                "permission": lambda request: user_has_group_or_permission(
                    request.user, "view_conditioncheck"
                ),
            }
